            ...
            <div class="row mb-3 pt-sm-3">
                <div class="col-md-12">
                    ...
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" 
                        EmptyDataText="No Record to Display..." AutoGenerateColumns="False" AllowPaging="True" PageSize="5" DataKeyNames="JobId" Width="1545px" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowDeleting="GridView1_RowDeleting"
                            ...
                            <asp:TemplateField HeaderText="Edit">
                                <ItemTemplate>
                                   <asp:LinkButton ID="btnEditJob" runat="server" CommandName="EditJob" CommandArgument='<%# Eval("JobId") %>'>
                                        ...
                                        <asp:Image ID="Img" runat="server" ImageUrl="../assets/img/icon/editPencil.png" Height="25px" Width="25px"/>
