        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Request.QueryString["id"] != null)
                {
                    ...
                    query = @"Update Jobs set Title=@Title,NoOfPost=@NoOfPost,
                                Description=@Description,Qualification=@Qualification
                                ,Experience=@Experience,Specialization=@Specialization,
                                LastDateToApply=@LastDateToApply,Salary=@Salary,JobType=@JobType,CompanyName=@CompanyName," + concatQuery + @"Website=@Website,Email=@Email,Address=@Address where JobId=@id";
                    type = "updated";
                    cmd = new SqlCommand(query, con);
                ...
                {
                    query = "Insert into Jobs Values(@Title,@NoOfPost,@Description,@Qualification,@Experience,@Specialization,@LastDateToApply,@Salary,@JobType,@CompanyName,@CompanyImage,@Website,@Email,@Address,@CreateDate)";
                    type = "inserted";
                ...
                if (isValideToExecute)
                {
                    ...
                    {
                        lblMsg.Text = "Cannot" + type + "the record, please try after sometime!";
                        lblMsg.CssClass = "alert alert-danger";
                    }
                }
