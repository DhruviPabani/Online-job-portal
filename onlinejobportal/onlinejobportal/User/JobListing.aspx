...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.0.3/css/font
awesome.css"
                                ...
                                <div class="small-section-tittle2 mb-20">
                                    <div class="ion">
                                        <svg
                                            ...
                                            <path fill-rule="evenodd" fill="rgb(27, 207, 
107)"
                                                d="M7.778,12.000 L12.222,12.000 
L12.222,10.000 L7.778,10.000 L7.778,12.000 ZM-0.000,-0.000 L-0.000,2.000 L20.000,2.000 
L20.000,-0.000 L-0.000,-0.000 ZM3.333,7.000 L16.667,7.000 L16.667,5.000 L3.333,5.000 
L3.333,7.000 Z" />
                                        </svg>
                                    </div>
                                    <h6>Filter Jobs</h6>
                                ...
                                <div class="select-Categories pb-50">
                                    ...
                                    <div class="radiobuttoncontainer">
                                        <asp:RadioButtonList ID="RadioButtonList1"
                                            runat="server" CssClass="radiobuttonlist" AutoPostBack="true"
                        ...
                        <section class="featured-job-area">
                            <div class="container">
                                ...
                                <asp:DataList ID="DataList1" runat="server">
                                    <ItemTemplate>
                                        <div class="single-job-items mb-30 ml-100">
                                            <div class="job-items">
                                                <div class="company-img">
                                                    <a href="JobDetails.aspx?id=<%# Eval("JobId") %>">
                                                        <img width="80" src="<%# GetImageUrl( Eval("CompanyImage")) %>"
                                                            alt="">
                                                    </a>
                                                </div>
