...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <main>
        ...
        <div class="single-slider section-overly slider-height2 d-flex align-items-center" data-background="../assets/img/hero/job.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
        ...
        <div class="job-post-company pt-120 pb-120">
            <div class="container">
                ...
                <asp:DataList ID="DataList1" runat="server" OnItemCommand="DataList1_ItemCommand" OnItemDataBound="DataList1_ItemDataBound1">
                    <ItemTemplate>                    
